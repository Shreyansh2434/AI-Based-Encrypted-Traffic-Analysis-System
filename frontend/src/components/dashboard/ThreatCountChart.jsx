/**
 * Threat Count Chart - Uniform Professional SOC Grade
 */

export default function ThreatCountChart({ counts, height = 180 }) {
  ...
  return (
    <div className="chart-wrapper full-width">
      <div className="chart-header">
        ...
        <span className="chart-subtitle">Attack classification breakdown</span>
      </div>
      <svg
        width="100%"
        height={chartHeight}
